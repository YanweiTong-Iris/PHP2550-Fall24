...
# Define a function to create a histogram for each environmental factor
...
race_time_gender_age = ggplot(merged_main, aes(x = Age, y = NetRaceTime, color = Gender)) +
...
off_record_gender_age + race_time_gender_age
```
